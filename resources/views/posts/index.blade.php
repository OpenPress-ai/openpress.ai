                    ...
                    <x-shad.card class="h-full">
                        ...
                        <x-shad.card-footer>
                            <div class="flex flex-col space-y-2">
                                <x-shad.button tag="a" href="https://x.com/OpenAgentsInc/status/1841710204691288356" target="_blank" rel="noopener noreferrer" variant="outline" size="sm" class="w-full">
